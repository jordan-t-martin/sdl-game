...
{
	health_text = new Text(renderer, "res/consola.ttf", 30, std::to_string(health), { 255, 0, 0 , 255 });
}
...
void Target::update(SDL_Renderer* renderer) {
	health_text->reloadTexture(renderer, "res/consola.ttf", 30, std::to_string(health), { 0, 128, 0 , 255 });
